/**
 * Cyberpunk synthesized audio effects using Web Audio API.
 * No external asset dependencies, zero network latency, toggleable.
 */
...
export const soundEffects = {
  ...
  crit: () => {
    ...
    try {
      ...
      osc2.frequency.exponentialRampToValueAtTime(80, ctx.currentTime + 0.25);
